...
class ShiftDataset_my(LyftDataset_my):
    r"""Shift Dataset.
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        pre_token = mmcv.load('/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/SHIFT/eval_order.pkl')
    ...
    def format_results(self, results, jsonfile_prefix=None, csv_savepath=None):
        ...
        print(len(results))
        mmcv.dump(results, '/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/work_dirs/bevdet-r50-cbgs-shift2X-car/format_results1.pkl')
        # 3780
