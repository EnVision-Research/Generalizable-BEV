...
from .lyft_dataset import LyftDataset_my
from .pipelines import Compose


@DATASETS.register_module(force=ture)
    ...
    def load_gts(self):
        ...
        for data_info in mmcv.track_iter_progress(self.data_infos):
            ...
            for index in range(len(sample_annotations[0])):
                xyzw = Quaternion(sample_annotations[0][index][6])
                ...
                annotation = {
                    ...
                    'rotation': [xyzw.w, xyzw.x, xyzw.y, xyzw.z],
