...
#bash tools/dist_train.sh  ./configs/bevdet_our/bevdepth-r50-cbgs-pc-da.py  8
#bash tools/dist_train.sh  ./configs/bevdet_our/bevdepth-r50-cbgs-pc-lyft.py  8


#bash tools/dist_train.sh  ./configs/111111_PCBEV/pcbev-r50-cbgs-DA2X-dg.py  8
#bash tools/dist_train.sh  ./configs/111111_PCBEV/pcbev-r50-cbgs-LYFT2X-dg.py  8
