...
Source_classes=['car', 'truck', 'construction_vehicle', 'bus', 'trailer', 'barrier',
    'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone']
...
data_config = {
    ...
    'extri_z_aug': (-2.0, 2.0),
    # # Aligned Intri
    # 'Target_Focal_low': 500,
    # 'Target_Focal_hight': 600,
    # # Intri Augmentation
...
test_data_config = dict(
    ...
    ann_file_source='./data/nuscenes/' + 'bevdetv2-nuscenes_infos_train.pkl',
    ann_file_target= './data/lyft/' + 'lyft_infos_ori_ann_train.pkl',
