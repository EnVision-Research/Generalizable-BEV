...
# Data
dataset_type = 'NuScenesDataset'  # LyftDataset_my use_valid_flag=False, # LyftDataset时要注释掉img_info_prototype和use_valid_flag，NuScenesDataset时选择False
